  ...
  return (
    <>
      ...
      <div className="flex flex-col p-2 justify-items-center justify-center bg-sky-900">
        {/* titulo */}
        <div className="font-ftitles text-white text-center text-3xl m-5">
        ...
        <div className="grid grid-flow-row sm:grid-flow-col justify-items-center my-10 place-content-evenly gap-y-10">
          <div className="h-80 font-ftext bg-white place-content-center text-justify rounded-xl max-w-sm p-8 m-2 shadow-xl shadow-neutral-900/50 border border-sky-900">
