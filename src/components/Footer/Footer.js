...
const Footer = () => {
  ...
  return (
    <div className="absolute grid items-center w-full h-auto grid-cols-1 grid-row-3 py-8 mt-20 text-sky-900 bg-white justify-items-center sm:grid-cols-3 sm:grid-rows-1 border-t border-t-sky-900">
      ...
      <div className="row-start-1 row-end-2 sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-2 self-start">
        ...
        {
            info.map(e => 
                <li key={e.key} className='grid grid-cols-1 py-2 m-4 italic font-normal text-left text-normal sm:hover:text-orange-600 justify-items-center sm:justify-items-start'>
      ...
      <div className="self-start row-start-2 row-end-3 sm:col-start-3 sm:col-end-4 sm:row-start-1 sm:row-end-2">
        <div>
          ...
          {
                redes.map(e =>  
                <li key={e.list} className="py-4 font-ftext text-xl text-left italic sm:hover:scale-125">
